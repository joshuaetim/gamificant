    ...
    @forelse ($popularGames as $game)
        <div class="game mt-8">
            <div class="relative inline-block">
                <a href="#">
                    <img src="{{Str::replaceFirst('thumb', 'cover_big', $game['cover']['url'])}}" alt="game image" class="hover:opacity-75 transition ease-in-out duration-150">
                </a>
            ...
            <a href="#" class="font-semibold text-base mt-8 block hover:text-gray-400 leading-tight">{{$game['name']}}</a>
