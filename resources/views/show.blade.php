    ...
    <div class="container mx-auto px-4">
        <div class="flex border-b border-gray-600 pb-12 lg:flex-row flex-col">
            <div class="flex-none">
                ...
                @else
                    <img src="https://via.placeholder.com/264x350?text=No+Image+Found" alt="game cover">
                @endif
            </div>
                ...
                <div class="flex flex-wrap mt-8">
                    @if (isset($game['rating']))
                        <div class="flex items-center">
                            <div id="rating" class="w-16 h-16 bg-gray-800 rounded-full relative text-xs font-semibold">
                    ...
                    @if (isset($game['aggregated_rating']))
                        <div class="flex items-center ml-12">
                            <div id="aggregatedRating" class="w-16 h-16 bg-gray-800 rounded-full text-xs font-semibold relative">
                                @include('partials.rating', [
                ...
                @foreach ($game['similar_games'] as $game)
                    <div class="game mt-8">
                        <div class="relative inline-block">
                            ...
                            @else
                                <a href="{{route('games.show', $game['slug'])}}">
                                    <img src="https://via.placeholder.com/264x350?text=No+Image+Found" alt="game image" class="hover:opacity-75 transition ease-in-out duration-150">
                                </a>
                            @endif
                            @if (isset($game['rating']))
                                <div id="{{$game['slug']}}" class="absolute w-16 h-16 rounded-full bg-gray-800 bottom-0 right-0" style="bottom: -20px; right: -20px">
                                    @include('partials.rating', [
                                        'slug' => $game['slug'],
                                        'rating' => $game['rating'],
                                    ])
